 ...
 *  /n 博客: http://blog.csdn<a href="http://lib.csdn.net/base/dotnet" class='replace_word' title=".NET知识库" target='_blank' style='color:#df3434; font-weight:bold;'>.NET</a>/wujian53 http://www.cppblog.com/llbird  
 *  /n 维护: 2002.10 - 2009.4
 *
 *  /section Announce 说明
 ...
 *  /n 2009 v1.5 增加内置分块链表缓冲区; 增加对WINCE的支持(模拟器下<a href="http://lib.csdn.net/base/softwaretest" class='replace_word' title="软件测试知识库" target='_blank' style='color:#df3434; font-weight:bold;'>测试</a>通过);
...
/*! /class CnComm 
	/version 1.5 
	/date 2002.10-2009.4
	/author llbird(wushaojian@21cn.com http://www.cppblog.com/llbird  http://blog.csdn<a href="http://lib.csdn.net/base/dotnet" class='replace_word' title=".NET知识库" target='_blank' style='color:#df3434; font-weight:bold;'>.Net</a>/wujian53) 
